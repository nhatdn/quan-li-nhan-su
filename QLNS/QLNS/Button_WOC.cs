...
namespace ePOSOne.btnProduct
{
    public class Button_WOC : Button
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            g.FillEllipse(brush, 0, 0, Height - fix, Height - fix);
            g.FillEllipse(brush, Width - Height, 0, Height - fix, Height - fix);
            g.FillRectangle(brush, Height / 2, 0, Width - Height, Height - fix);
